                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">1. Dirigase al menu principal. Selecione el boton que diga "Compras"</p>
                            <div class="container text-center img-size">
                                <img src="../imagenes/Compra-modulo.png" class="img-thumbnail">
                            </div>
                            <p class="card-text">2. Una vez aqui, selecione el producto que desea comprar.</p>
                            <p class="card-text">3. Ingrese los datos que se le pide en la parte superior del modulo.</p>
                            <p class="card-text">4. Con los datos ingresados, haga click en el buton de "Agregar al carrito".</p>
                            <div class="container text-center img-size">
                            ...
                            <p class="card-text">5. Una vez que haya ingresado todos los productos que desea comprar; haga clic en el boton "Comprar".</p>
                        </div>
                    </div>
                </div>
            </div>
